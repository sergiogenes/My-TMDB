...
const Content = ({ config }) => {
  ...
  useEffect(() => {
    if (contentId) {
      axios
        .get(
          `${base_url}/discover/${contentId}?api_key=${api_key}&language=en-US&sort_by=popularity.desc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate`
        )
